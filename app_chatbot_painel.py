#resposta no painel porém meio estranha 
...
QUESTION_PROMPT = PromptTemplate.from_template("""Dada a seguinte conversa e uma pergunta de acompanhamento, reformule a pergunta de acompanhamento para ser uma pergunta autônoma.
    ...
    if event.new:
        ...
        if question:
            ...
            if result and len(result) > 0:
                answer = result[0]  # Supondo que a resposta está na primeira posição da lista
